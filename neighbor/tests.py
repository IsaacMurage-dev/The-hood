...
class NeighborhoodTestClass(TestCase):
    def setUp(self):
        ...
        '''
        self.newhood=Neighborhood(hoodpic='pic.jpg',hoodname='Riverdale',numberofpeople='265',hoodlocation='Riverside')
...
class BusinessTestClass(TestCase):
    def setUp(self):
        ...
        '''
        self.hood=Neighborhood(hoodpic='pic.jpg',hoodname='Riverdale',numberofpeople='265',hoodlocation='Riverside')
        '''
        saving the foreign key instance
        '''
        self.hood.save()
        ...
        '''
        self.biz=Business(businessname='general motors',businesspic='img.jpg',businessemail='aizo@gmail.com',editor=self.newuser,area=self.hood)
    def test_instance(self):
        '''
